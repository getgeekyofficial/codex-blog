...
keyTakeaways:
  - "Scientists achieved quantum entanglement over 12,000 km using satellites, proving global quantum internet is feasible"
  - "Quantum teleportation now works over standard fiber optic cables, no infrastructure rebuild needed"
  - "AI tool PyTheus discovered novel entanglement methods, solving equations that stumped human physicists for decades"
citations:
  - title: "Satellite-to-ground quantum key distribution over 12,000 km"
    author: "Yin, J., et al."
    year: 2024
    publication: "Nature Physics"
  - title: "Quantum teleportation across metropolitan fibers"
    author: "Northwestern University"
    year: 2024
    publication: "Northwestern Research"
  - title: "PyTheus: Automated discovery of quantum experiments"
