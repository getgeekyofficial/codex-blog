...
keyTakeaways:
  - "Cognitive biases are evolutionary shortcuts that can be exploited in the digital age"
  - "Confirmation bias makes us favor information that confirms existing beliefs, creating echo chambers"
  - "Understanding these mental vulnerabilities is the first step to reclaiming rational decision-making"
citations:
