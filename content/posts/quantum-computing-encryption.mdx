...
keyTakeaways:
  - "Quantum computers using Shor's algorithm will break RSA and ECC encryption by 2030-2035, rendering current internet security obsolete"
  - "Adversaries are conducting 'Harvest Now, Decrypt Later' attacks, storing encrypted data to decrypt when quantum computers mature"
  - "NIST released post-quantum cryptography standards in August 2024, but organizations need 5-10 years to migrate—we're dangerously behind"
citations:
  ...
  - title: "FIPS 203, 204, 205 - Post-Quantum Standards"
    author: "NIST"
    year: 2024
