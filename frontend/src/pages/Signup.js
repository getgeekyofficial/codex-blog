    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-[#0a0a0a] relative">
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in-up">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-2" data-testid="signup-title">GetGeeky Codex</h1>
          <p className="text-muted-foreground font-mono text-sm uppercase tracking-wider">INITIALIZE ACCESS</p>
        </div>

        <div className="glass-card p-8 rounded-md">
          <form onSubmit={handleSubmit} className="space-y-6" data-testid="signup-form">
            <div>
              <Label htmlFor="name" className="text-sm font-mono uppercase tracking-wider">Name</Label>
              <Input
                id="name"
                type="text"
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              Already have access?{' '}
              <Link to="/login" className="text-primary hover:text-primary/80 font-medium" data-testid="login-link">
                Sign In
              </Link>
            </p>
          </div>
